    ...
    public class Seed
    {
        public static async Task SeedUsers(UserManager<AppUser> userManager, RoleManager<AppRole> roleManager)
        {
            ...
            foreach (var user in users)
            {
                ...
                await userManager.AddToRoleAsync(user, "Member");   //add user to the role
            }
            ...
            await userManager.AddToRolesAsync(admin, new[] { "Admin", "Moderator" }); //Roles gt theloume Admin kai Moderator
        }
    }
}